...
import { userId, API_BASE_URL } from './services/api';
...
function App() {
    ...
    useEffect(() => {
        ...
        // Check API connection using absolute Base URL
        ...
        // Check bot status using absolute Base URL
        const checkBot = async () => {
            try {
                const botStatusUrl = API_BASE_URL.replace('/api', '') + '/api/bot/status';
                const res = await fetch(botStatusUrl);
                const data = await res.json();
                setBotOnline(data.enabled ?? (data.bot?.isRunning || false));
        ...
        <div className="App">
            <header className="app-header">
                <div className="header-brand">
                    ...
                    <div>
                        <div className="header-title">USDCAD Confluence Terminal</div>
                        <div className="header-subtitle">USDCAD Spot Automated Terminal</div>
                    </div>
                </div>
